...
Future<List<Post>> fetchPost() async {
  final response = await http.get('http://newzsort.herokuapp.com/categories2/post');
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    if(snapshot.data[index].urlToImage==null){
                      snapshot.data[index].urlToImage="https://images.wsj.net/im-210721/social";  //temporary image, must be set in case url is null
                    }
                    String date=snapshot.data[index].time;
                    String date1="",time1=""; //code to separate date and time from json response
                    int i;
